...
nchan = 32
print keith_func.getKVolts(1,nchan)
...
# voltages = np.arange(-2.5,2.75,0.25)   # Specify voltages to loop through
# code_array = []
# meas_volts = []
...
# for i in range (0, len(voltages)):
    ...
    # #code_array[i].append(keith_func.getKVolts_all(nchan)) # Get recorded voltage from KMUX
