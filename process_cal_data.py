...
def process(date_time,model,nchan,serial_num,temperature,samp_rate,firm_rev,fpga_rev):
    ...
    if 'ACQ437' in model :
        data = SubElement(acqcal, 'Data', AICHAN=str(nchan), code_min=str(min_codes), code_max=str(max_codes), sw="hi_res_mode,G%02d")
        ...
        data = SubElement(acqcal, 'Data', AICHAN=str(nchan), code_min=str(min_codes), code_max=str(max_codes), sw="G%02d")
        # ACQ42X GAINS
