...
for channel in range (1,nchan+1):
    ...
    str_v = str(v)
    print "V = "+str_v
    results_array[channel-1].append(v) # Append recorded voltage to sublist
    ...
    # start = time.time()
    # v_all = keith_func.getKVolts_all(nchan) # Get recorded voltage from KMUX
    # print v_all
    ...
    csv_write.writerow(results_array[channel-1])  # Write to CSV, format as below
